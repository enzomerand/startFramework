...
namespace Core\Social\SoundCloud;
...
class Services_Soundcloud
{
     ...
     *
     * @return void
     * @throws Soundcloud\Services_Soundcloud_Missing_Client_Id_Exception
     *
     * @access public
     */
    ...
    {
        if (empty($clientId)) {
            throw new Soundcloud\Exception\Services_Soundcloud_Missing_Client_Id_Exception();
        }
    ...
    function getAudioMimeType($extension)
    {
        if (array_key_exists($extension, self::$_audioMimeTypes)) {
            ...
            throw new Soundcloud\Exception\Services_Soundcloud_Unsupported_Audio_Format_Exception();
        }
    }
    ...
    function setResponseFormat($format)
    {
        if (array_key_exists($format, self::$_responseFormats)) {
            ...
            throw new Soundcloud\Exception\Services_Soundcloud_Unsupported_Response_Format_Exception();
        }
    ...
    {
        return self::$_userAgent . '/' . new Soundcloud\Services_Soundcloud_Version;
    }
    ...
    protected function _request($url, $curlOptions = array())
    {
        ...
        if ($this->_validResponseCode($this->_lastHttpResponseCode)) {
            ...
            throw new Soundcloud\Exception\Services_Soundcloud_Invalid_Http_Response_Code_Exception(
                null,
                0,
